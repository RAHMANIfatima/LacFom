from Algo.foetus import *
from Algo.mere import *
from Algo.pere import *
from Algo.temoin import *
...
class Echantillon:
    ...
    def __init__(self, date, mere, foetus, tpos, tneg, pere = None, seuil_nbre_marqueurs=2, seuil_hauteur=1 / 3, kit=None):
